    ...
    <div className="hero_section">
      ...
      <div className="bg-hero-section-img bg-no-repeat bg-center bg-cover">
        ...
        <div className="container xl:w-[1180px] 2xl:w-[1320px]  px-3 sm:px-5 xl:px-0 mx-auto hero-content flex items-start justify-center flex-col">
          <div className="flex flex-col justify-center xl:pt-[70px] xl:pb-[130px] text-center sm:text-start mx-auto sm:mx-0">
            <h1 className="text-[37px] sm:text-[61px]  xl:text-6xl  text-white max-w-2xl leading-[130%] lg:leading-[120%] 2xl:leading-[130%] font-Jakarta font-bold">
              <span className="mb-0 font-light ">Open Up to</span> Experience
              More
            </h1>
            <p className="font-Jakarta font-medium py-[20px] md:mt-8 mb-[35px] text-[16px] sm:text-md md:text-xl leading-[160%] md:leading-[140%] text-white max-w-[400px] mx-auto sm:mx-0">
              American-crafted railing, fencing and lighting for retreat-style
              living.
            </p>
            <div className="flex flex-row gap-4 sm:gap-8 mx-auto sm:mx-0 pb-12">
