  ...
  return (
    <div className="bg-[#5a623d]  relative">
      ...
      <div className="xl:w-[1180px] 2xl:w-[1320px] mx-auto px-3 sm:px-5 xl:px-0">
        <div className="w-full pb-12 md:pb-[55px] pt-12 md:pt-[50px] xl:pb-[95px] xl:pt-[89px] lg:pe-[11px] xl:px-5">
          <div className="flex justify-center xl:justify-start text-center xl:text-start">
            <h3 className="text-white font-Jakarta font-medium text-[35px] sm:text-[40px] lg-[35px] leading-[51px]">
              Visualize Your Fence
            </h3>
          </div>
          <div className="flex justify-center text-center xl:text-start xl:justify-start mt-5">
            <p className="font-Jakarta text-white max-w-[470px] font-normal text-xs md:text-md mb-5">
              Use our Fence Builder visualizer to preview how our products will
              transform your outdoor living area.
            </p>
          </div>
          <div className="flex justify-center xl:justify-start">
            <div className="mt-5 hover:bg-light-brown duration-500 hover:text-black hover:border-2 text-white border-2 hover:border-[#eee4db] border-[#eee4db] py-4 px-[18px] sm:px-[28px] inline-block">
