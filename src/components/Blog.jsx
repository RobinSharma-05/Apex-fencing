...
const Blog = () => {
  return (
    <div
      ...
      id="section_5"
    >
      <h3 className=" font-Jakarta font-medium text-5xl dark-black ">
        Blog
      </h3>
      ...
      <div className="flex-col-2 flex-wrap xl:flex-nowrap flex justify-center xl:justify-between gap-5 pt-[76px]">
          ...
          <div className="max-w-[300px] xl:max-w-[500px] w-[100%] mt-5 md:mt-0 cursor-pointer bg-light-brown border-b-8 border-[#5A623D] img_hover">
          ...
          <div className="max-w-[300px] xl:max-w-[500px] w-[100%] mt-5 md:mt-0 cursor-pointer bg-light-brown border-b-8 border-[#695978] img_hover">
            <div className="overflow-hidden">
          ...
          <div className="max-w-[300px] xl:max-w-[500px] w-[100%] col-span-2 mt-5 md:mt-0 cursor-pointer bg-light-brown border-b-8 border-[#aa6627] img_hover">
            <div className="overflow-hidden">
